// Transcrypt'ed from Python, 2023-05-31 23:10:16
...
export var gmagnitude = 0.003;
export var eye =  __class__ ('eye', [object], {
	__module__: __name__,
	get __init__ () {return __get__ (this, function (self, x, y, magnitude) {
		if (arguments.length) {
			var __ilastarg0__ = arguments.length - 1;
			if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
				var __allkwargs0__ = arguments [__ilastarg0__--];
				for (var __attrib0__ in __allkwargs0__) {
					switch (__attrib0__) {
						...
						case 'magnitude': var magnitude = __allkwargs0__ [__attrib0__]; break;
					}
				}
			}
		}
...
var setup = function () {
	...
	var url = 'https://lh5.googleusercontent.com/lwD8-1x3CmpZKnEm8J9ntI4WSJtTauyMAuMJ4ZUnqwus_ue4rjOOjHP5VBKygMVBdogmGXW1p7TmYFmQ3A4ymNU';
	size (500, 586);
	webImg = loadImage (url, 'png');
	noStroke ();
};
export var eyel = eye (185, 250, gmagnitude);
export var eyer = eye (313, 250, gmagnitude);
var draw = function () {
	if (arguments.length) {
		var __ilastarg0__ = arguments.length - 1;
		if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
